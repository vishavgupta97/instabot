...
import urllib #FOR DOWNLOADING ANY MEDIA FROM WORLD WIDE WEB
import requests
from colorama import *
from PIL import Image
#thIS IS PYTHON IMAGE PROCESSING LIBRARY ,IAM USING CERTAIN METHODS OF THIS LIBRARY
def get_users_post(insta_username) :
    ...
    if user_media['meta']['code']==200 :
        if len(user_media['data']) :
            ...
            img.show()   #SHOWING IMAGE ON THE SCREEN AFTER DOWNLOADING IT
